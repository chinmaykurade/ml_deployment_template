...
#                     for example, we can set testing as initial status and then after testing period switch to
#                     production state.
# MLRequest -         to keep information about all requests to ML algorithms. It will be needed to monitor ML
#                     algorithms and run A/B tests.
